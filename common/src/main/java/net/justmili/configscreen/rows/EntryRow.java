...
import net.justmili.configscreen.ConfigScreenBuilder;
import net.justmili.configscreen.SharedElements;
import net.justmili.corelibs.v1.config.entry.ConfigEntry;
import net.justmili.corelibs.v1.config.screen.widgets.BoolButton;
...
import static net.justmili.configscreen.SharedElements.*;
