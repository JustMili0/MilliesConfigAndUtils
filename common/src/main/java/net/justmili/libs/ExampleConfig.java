...
import net.justmili.libs.v1.config.builder.ConfigEntry;
import net.justmili.libs.v1.config.builder.ListConfigEntry;
import net.justmili.libs.v1.config.builder.MConfigBuilder;
