 ...
 * Renamed constant AFTER_DEATH -> DEATH_POST;
 * logic unchanged.
 */
...
public final class LivingEntityEvents {
     ...
     */
    public static final Event<AfterDeath> DEATH_POST = EventFactory.createArrayBacked(AfterDeath.class, callbacks -> (entity, damageSource) -> {
