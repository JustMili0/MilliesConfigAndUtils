package net.justmili.libs.v1.events.server;

import net.justmili.libs.v1.events.base.CompoundEventResult;
import net.justmili.libs.v1.events.base.Event;
import net.justmili.libs.v1.events.base.EventResult;
