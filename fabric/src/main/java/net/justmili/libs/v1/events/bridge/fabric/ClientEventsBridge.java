package net.justmili.libs.v1.events.bridge.fabric;

import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientLifecycleEvents;
import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents;

import static net.justmili.libs.v1.events.client.ClientLifecycleEvents.STARTED;
import static net.justmili.libs.v1.events.client.ClientLifecycleEvents.STOPPING;
import static net.justmili.libs.v1.events.client.ClientTickEvents.*;
