...
public class MConfigBuilder {
    ...
    public MConfigBuilder(String modId, String name, FileType configFileType, boolean createSubDirectory) {
        this.config = new ConfigLoader(modId, name, configFileType, createSubDirectory);
    }
