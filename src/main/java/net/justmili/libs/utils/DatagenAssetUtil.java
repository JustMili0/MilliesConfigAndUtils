    ...
    public static class BlockModels {
        ...
        public static class Individual {
            ...
            public static void createFurnace(BlockModelGenerators blockGen, Block block) {
                ...
                Identifier litModel = ModelTemplates.CUBE_ORIENTABLE.create(
            ...
            public static void createChest(BlockModelGenerators blockGen, Block block) {
                ...
                Identifier leftModel = customBackOrientable.create(TextureMapping.getBlockTexture(block, "_left"), leftMapping, blockGen.modelOutput);
                Identifier rightModel = customBackOrientable.create(TextureMapping.getBlockTexture(block, "_right"), rightMapping, blockGen.modelOutput);
            ...
            public static void createCactus(BlockModelGenerators blockGen, Block block) {
                ...
                Identifier bottomTexture = TextureMapping.getBlockTexture(block, "_bottom");
                Identifier topTexture = TextureMapping.getBlockTexture(block, "_top");
            ...
            public static void createPlant(BlockModelGenerators blockGen, Block block, BlockModelGenerators.PlantType plantType) {
                blockGen.createCrossBlockWithDefaultItem(block, plantType);
            }

            public static void createTallPlant(BlockModelGenerators blockGen, Block block, BlockModelGenerators.PlantType plantType) {
        ...
        public static class RotationBlockstateOnly {
            public static void createY(BlockModelGenerators blockGen, Block block, Identifier modelLocation) {
            ...
            public static void createUPNWSE(BlockModelGenerators blockGen, Block block, Identifier modelLocation) {
                blockGen.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block,
                        Variant.variant().with(VariantProperties.MODEL, modelLocation))
                    .with(BlockModelGenerators.createFacingDispatch()));
            }

            public static void createXYZ(BlockModelGenerators blockGen, Block block, Identifier modelLocation) {
